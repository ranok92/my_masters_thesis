...
\begin{enumerate}
    ...
    \item What are the factors that make this problem hard to pin and thus hard to solvesdfasd? Include works from the paper "Influence of proxemic behaviours in human-robot interaction. (Takayama et al)
