...
\edited{\autoref{ch:6} contains details about the different experiments conducted and how the different components of the navigation algorithm, like the feature representation and the choice of the training algorithm, contribute to the final performance of the agent. Measuring the social compliance of an agent can be tricky. Keeping that in mind, we introduce a set of evaluation metrics, both qualitative and quantitative in this chapter. Lastly, we present a detailed analysis and subsequent evaluation of the results obtained and the contribution of the different components towards it.}
