...
Others concentrate on specific scenarios like approaching, tracking, and following people. \edited{Exploration of the environment plays an important role in the characterization of a mobile agent, \cite{rekleitis2003experiments} focuses on co-operative exploring free-space in an environment.}\\
