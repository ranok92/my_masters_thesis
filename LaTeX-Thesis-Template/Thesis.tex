...
\label{ch:chapter1}
\input{base/chapter/chapter1.tex}
\chapter{Data driven approach}
\label{ch:chapter2}
\input{base/chapter/chapter2.tex}

\part{Social Navigation using Inverse RL}
\chapter{The environment}
\label{ch:part3_chapter1}
\input{base/chapter/part3_chapter1.tex}

\chapter{Methodology}
\label{ch:part3_chapter2}
\input{base/chapter/part3_chapter2.tex}

\chapter{Experiments and results}
\label{ch:part4_chapter1}
\input{base/chapter/part4_chapter1.tex}
